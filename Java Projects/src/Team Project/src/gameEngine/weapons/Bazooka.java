...
public class Bazooka implements Weapon {
	...
	public Bazooka() {
		readImg("img" + File.separator + "weapSprites" + File.separator + "bazooka.png");
		readPanelImg("img" + File.separator +  "weapPanel" + File.separator + "bazookapanel.png");
		description = "Fires a parabola missile that destroys the ground and damages nearby enemies";
		details = "Bazooka - Fires a parabola missile that will be affected by winds.\n"
	...
	/**
	 * Damage the players on the radius and destroy the ground
	 * 
	 * @param center
	...
	/**
	 * Tests if a point is within the area of a circle
	 * (for blast radius)
	 * @param x
	 * @param y
	 * @param centerX
