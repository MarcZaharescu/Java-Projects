...
/**
 * LazerEX Weapon Class
 * 
 *
 */
public class LazerEX implements Weapon {

	private BufferedImage display;
	private BufferedImage panelSprite;
	private String name = "LazerEX";
	...
	public LazerEX() {
		...
		details = "LazerEX - Fires a straight line lazer to target, and deals 800 damage to the target it hits.\n"
	...
	public void animateShot(BufferedImage fancyMap,
		...
		// set the color along the path some times blue sometimes orange
		for (int i = 0; i < 120; i++) {
			try {
