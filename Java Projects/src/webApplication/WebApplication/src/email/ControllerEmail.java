	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("button1")!=null)
		{
			...
			try {
				...
				//prints on the page that the email has been sent and goes to the Database page
		...
		//if the Log out button is pressed goes back to the Login page printing Log Out on the page 
